...
$(document).ready(function() {
	...
	//image 7 functions________________________________________
	$("#people_7").one("click", function (){
		startTime7 = performance.now();
	});
	$("#people_7").click(function(e) {
		numClicks7++;
		$("#numpeoplefield7").val(numClicks7);
		$("#peoplecount7").text(numClicks7);
		var newDomElement = $("<div class='marker'></div>");
		newDomElement.css("left", (e.pageX-3)+"px");
		newDomElement.css("top", (e.pageY-3)+"px");
		$("body").append(newDomElement);
		elementHistory7.push(newDomElement);
		var endTime7 = performance.now();
		var timeTaken7 = endTime7-startTime7;
		$("#timetaken7").val(timeTaken7);
	});
	$("#undobutton7").click(function() {
		numClicks7--;
		$("#numpeoplefield7").val(numClicks7);
		$("#peoplecount7").text(numClicks7);
		var elementToRemove = elementHistory7.pop();
		elementToRemove.remove();
	});
